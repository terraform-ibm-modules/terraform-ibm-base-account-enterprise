...
| <a name="input_admin_compute_ag_ibm_ids"></a> [admin\_compute\_ag\_ibm\_ids](#input\_admin\_compute\_ag\_ibm\_ids) | A list of IBM IDs you want to add to the admin compute access group | `list(string)` | `null` | no |
| <a name="input_admin_compute_ag_name"></a> [admin\_compute\_ag\_name](#input\_admin\_compute\_ag\_name) | Name of the Administrator Compute access group | `string` | `null` | no |
| <a name="input_admin_compute_ag_policies"></a> [admin\_compute\_ag\_policies](#input\_admin\_compute\_ag\_policies) | A map of policies for the Administrator Compute access group, has a set of default policies that can be overridden | <pre>map(object({<br>    roles              = list(string)<br>    account_management = optional(bool)<br>    tags               = set(string)<br>    resources = optional(list(object({<br>      region               = optional(string)<br>      attributes           = optional(map(string))<br>      service              = optional(string)<br>      resource_instance_id = optional(string)<br>      resource_type        = optional(string)<br>      resource             = optional(string)<br>      resource_group_id    = optional(string)<br>    })))<br>    resource_attributes = optional(list(object({<br>      name     = string<br>      value    = string<br>      operator = optional(string)<br>    })))<br>  }))</pre> | `null` | no |
| <a name="input_admin_compute_ag_service_ids"></a> [admin\_compute\_ag\_service\_ids](#input\_admin\_compute\_ag\_service\_ids) | A list of Service IDs you want to add to the admin compute access group | `list(string)` | `null` | no |
| <a name="input_admin_compute_ag_tags"></a> [admin\_compute\_ag\_tags](#input\_admin\_compute\_ag\_tags) | The list of tags that you want to associated with your admin compute access group | `list(string)` | `null` | no |
...
| <a name="input_admin_network_ag_ibm_ids"></a> [admin\_network\_ag\_ibm\_ids](#input\_admin\_network\_ag\_ibm\_ids) | A list of IBM IDs that you want to add to the admin network access group | `list(string)` | `null` | no |
| <a name="input_admin_network_ag_name"></a> [admin\_network\_ag\_name](#input\_admin\_network\_ag\_name) | Name of the Administrator Network access group | `string` | `null` | no |
...
| <a name="input_admin_network_ag_service_ids"></a> [admin\_network\_ag\_service\_ids](#input\_admin\_network\_ag\_service\_ids) | A list of Service IDs that you want to add to the admin network access group | `list(string)` | `null` | no |
| <a name="input_admin_network_ag_tags"></a> [admin\_network\_ag\_tags](#input\_admin\_network\_ag\_tags) | The list of tags that you want to associated with your admin network access group | `list(string)` | `null` | no |
...
| <a name="input_admin_observability_ag_ibm_ids"></a> [admin\_observability\_ag\_ibm\_ids](#input\_admin\_observability\_ag\_ibm\_ids) | A list of IBM IDs that you want to add to the admin observability access group | `list(string)` | `null` | no |
| <a name="input_admin_observability_ag_name"></a> [admin\_observability\_ag\_name](#input\_admin\_observability\_ag\_name) | Name of the Administrator Observability access group | `string` | `null` | no |
...
| <a name="input_admin_observability_ag_service_ids"></a> [admin\_observability\_ag\_service\_ids](#input\_admin\_observability\_ag\_service\_ids) | A list of Service IDs that you want to add to the admin observability access group | `list(string)` | `null` | no |
| <a name="input_admin_observability_ag_tags"></a> [admin\_observability\_ag\_tags](#input\_admin\_observability\_ag\_tags) | The list of tags that you want to associated with your admin observability access group | `list(string)` | `null` | no |
...
| <a name="input_admin_security_ag_ibm_ids"></a> [admin\_security\_ag\_ibm\_ids](#input\_admin\_security\_ag\_ibm\_ids) | A list of IBM IDs that you want to add to the admin security access group | `list(string)` | `null` | no |
| <a name="input_admin_security_ag_name"></a> [admin\_security\_ag\_name](#input\_admin\_security\_ag\_name) | Name of the Administrator Security access group | `string` | `null` | no |
...
| <a name="input_admin_security_ag_service_ids"></a> [admin\_security\_ag\_service\_ids](#input\_admin\_security\_ag\_service\_ids) | A list of Service IDs that you want to add to the admin security access group | `list(string)` | `null` | no |
| <a name="input_admin_security_ag_tags"></a> [admin\_security\_ag\_tags](#input\_admin\_security\_ag\_tags) | The list of tags that you want to associated with your admin security access group | `list(string)` | `null` | no |
...
| <a name="input_observer_compute_ag_service_ids"></a> [observer\_compute\_ag\_service\_ids](#input\_observer\_compute\_ag\_service\_ids) | A list of Service IDs you want to add to the observer compute access group | `list(string)` | `null` | no |
| <a name="input_observer_compute_ag_tags"></a> [observer\_compute\_ag\_tags](#input\_observer\_compute\_ag\_tags) | The list of tags that you want to associated with your observer compute access group | `list(string)` | `null` | no |
...
| <a name="input_observer_network_ag_ibm_ids"></a> [observer\_network\_ag\_ibm\_ids](#input\_observer\_network\_ag\_ibm\_ids) | A list of IBM IDs you want to add to the observer network access group | `list(string)` | `null` | no |
| <a name="input_observer_network_ag_name"></a> [observer\_network\_ag\_name](#input\_observer\_network\_ag\_name) | Name of the Observer Network access group | `string` | `null` | no |
...
| <a name="input_observer_network_ag_service_ids"></a> [observer\_network\_ag\_service\_ids](#input\_observer\_network\_ag\_service\_ids) | A list of Service IDs you want to add to the observer network access group | `list(string)` | `null` | no |
| <a name="input_observer_network_ag_tags"></a> [observer\_network\_ag\_tags](#input\_observer\_network\_ag\_tags) | The list of tags that you want to associated with your observer network access group | `list(string)` | `null` | no |
...
| <a name="input_observer_observability_ag_ibm_ids"></a> [observer\_observability\_ag\_ibm\_ids](#input\_observer\_observability\_ag\_ibm\_ids) | A list of IBM IDs you want to add to the observer observability access group | `list(string)` | `null` | no |
| <a name="input_observer_observability_ag_name"></a> [observer\_observability\_ag\_name](#input\_observer\_observability\_ag\_name) | Name of the Observer Observability access group | `string` | `null` | no |
...
| <a name="input_observer_observability_ag_service_ids"></a> [observer\_observability\_ag\_service\_ids](#input\_observer\_observability\_ag\_service\_ids) | A list of Service IDs you want to add to the observer observability access group | `list(string)` | `null` | no |
| <a name="input_observer_observability_ag_tags"></a> [observer\_observability\_ag\_tags](#input\_observer\_observability\_ag\_tags) | The list of tags that you want to associated with your observer observability access group | `list(string)` | `null` | no |
...
| <a name="input_observer_security_ag_ibm_ids"></a> [observer\_security\_ag\_ibm\_ids](#input\_observer\_security\_ag\_ibm\_ids) | A list of IBM IDs you want to add to the observer security access group | `list(string)` | `null` | no |
| <a name="input_observer_security_ag_name"></a> [observer\_security\_ag\_name](#input\_observer\_security\_ag\_name) | Name of the Observer Security access group | `string` | `null` | no |
...
| <a name="input_observer_security_ag_service_ids"></a> [observer\_security\_ag\_service\_ids](#input\_observer\_security\_ag\_service\_ids) | A list of Service IDs you want to add to the observer security access group | `list(string)` | `null` | no |
| <a name="input_observer_security_ag_tags"></a> [observer\_security\_ag\_tags](#input\_observer\_security\_ag\_tags) | The list of tags that you want to associated with your observer security access group | `list(string)` | `null` | no |
...
| <a name="input_privileged_compute_ag_ibm_ids"></a> [privileged\_compute\_ag\_ibm\_ids](#input\_privileged\_compute\_ag\_ibm\_ids) | A list of IBM IDs you want to add to the privileged compute access group | `list(string)` | `null` | no |
| <a name="input_privileged_compute_ag_name"></a> [privileged\_compute\_ag\_name](#input\_privileged\_compute\_ag\_name) | Name of the Privileged Compute access group | `string` | `null` | no |
...
| <a name="input_privileged_compute_ag_service_ids"></a> [privileged\_compute\_ag\_service\_ids](#input\_privileged\_compute\_ag\_service\_ids) | A list of Service IDs you want to add to the privileged compute access group | `list(string)` | `null` | no |
| <a name="input_privileged_compute_ag_tags"></a> [privileged\_compute\_ag\_tags](#input\_privileged\_compute\_ag\_tags) | The list of tags that you want to associated with your privileged compute access group | `list(string)` | `null` | no |
...
| <a name="input_privileged_network_ag_ibm_ids"></a> [privileged\_network\_ag\_ibm\_ids](#input\_privileged\_network\_ag\_ibm\_ids) | A list of IBM IDs you want to add to the privileged network access group | `list(string)` | `null` | no |
| <a name="input_privileged_network_ag_name"></a> [privileged\_network\_ag\_name](#input\_privileged\_network\_ag\_name) | Name of the Privileged Observability access group | `string` | `null` | no |
...
| <a name="input_privileged_network_ag_service_ids"></a> [privileged\_network\_ag\_service\_ids](#input\_privileged\_network\_ag\_service\_ids) | A list of Service IDs you want to add to the privileged network access group | `list(string)` | `null` | no |
| <a name="input_privileged_network_ag_tags"></a> [privileged\_network\_ag\_tags](#input\_privileged\_network\_ag\_tags) | The list of tags that you want to associated with your privileged network access group | `list(string)` | `null` | no |
...
| <a name="input_privileged_observability_ag_ibm_ids"></a> [privileged\_observability\_ag\_ibm\_ids](#input\_privileged\_observability\_ag\_ibm\_ids) | A list of IBM IDs you want to add to the privileged observability access group | `list(string)` | `null` | no |
| <a name="input_privileged_observability_ag_name"></a> [privileged\_observability\_ag\_name](#input\_privileged\_observability\_ag\_name) | Name of the Privileged Observability access group | `string` | `null` | no |
...
| <a name="input_privileged_observability_ag_service_ids"></a> [privileged\_observability\_ag\_service\_ids](#input\_privileged\_observability\_ag\_service\_ids) | A list of Service IDs you want to add to the privileged observability access group | `list(string)` | `null` | no |
| <a name="input_privileged_observability_ag_tags"></a> [privileged\_observability\_ag\_tags](#input\_privileged\_observability\_ag\_tags) | The list of tags that you want to associated with your privileged observability access group | `list(string)` | `null` | no |
...
| <a name="input_privileged_security_ag_ibm_ids"></a> [privileged\_security\_ag\_ibm\_ids](#input\_privileged\_security\_ag\_ibm\_ids) | A list of IBM IDs you want to add to the privileged security access group | `list(string)` | `null` | no |
| <a name="input_privileged_security_ag_name"></a> [privileged\_security\_ag\_name](#input\_privileged\_security\_ag\_name) | Name of the Privileged Security access group | `string` | `null` | no |
...
| <a name="input_privileged_security_ag_service_ids"></a> [privileged\_security\_ag\_service\_ids](#input\_privileged\_security\_ag\_service\_ids) | A list of Service IDs you want to add to the privileged security access group | `list(string)` | `null` | no |
| <a name="input_privileged_security_ag_tags"></a> [privileged\_security\_ag\_tags](#input\_privileged\_security\_ag\_tags) | The list of tags that you want to associated with your privileged security access group | `list(string)` | `null` | no |
| <a name="input_provision_access_management"></a> [provision\_access\_management](#input\_provision\_access\_management) | Whether to enable provisioning of Access Managment access groups in the account. Default is true. | `bool` | `true` | no |
